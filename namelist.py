...
var_keys = {'ERA5': {'sst': 'sst', 'mslp': 'msl', 'temp': 't',
                     'sp_hum': 'q', 'u': 'u', 'v': 'v',
...
"""
start_year = 2019                     # year to start downscaling
start_month = 1                       # month of start_year to start downscaling
end_year = 2020                       # year to stop downscaling
...
tracks_per_year = 30                  # total number of tracks to simulate per year
